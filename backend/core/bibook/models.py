...
class Book(models.Model):
    ...
    translator = models.CharField(_('translator'), max_length=255,null=True, blank=True)
...
class Comment (models.Model):
    ...
    book = models.ForeignKey("bibook.Book", verbose_name=_("book"), on_delete=models.CASCADE)
